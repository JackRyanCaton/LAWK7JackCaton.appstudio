...
const cacheName = 'LAWK7JackCaton-2021-10-20 15:38:46.721815'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWK7JackCaton'.length) === 'LAWK7JackCaton') {
